  ...
  return (
    <div>
      ...
      <div className="pay-popup">
        ...
        <a href="#success" className="btn btn-lg theme-btn pay-btn mt-0" data-bs-toggle="modal">Pay Now</a>
      </div>
          ...
          <div className="modal-content">
            <div className="modal-body">
              <div className="confirm-title text-center">
                <img className="img-fluid confirm-offer" src="/fuzzy/assets/images/gif/success.gif" alt="success-payment" />
              ...
              <a href="/order-tracking" className="btn theme-btn w-100 mt-4" role="button">Track Order Now</a>
              <a href="/home" className="btn gray-btn mt-3">Continue Shopping</a>
            </div>
          </div>
        </div>
      </div>
